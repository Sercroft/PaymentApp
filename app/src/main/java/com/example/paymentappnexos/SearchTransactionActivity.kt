...
class SearchTransactionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editTextReceiptId   = findViewById(R.id.editTextReceiptId)
    ...
    private fun searchTransaction(receiptId: String){
        GlobalScope.launch(Dispatchers.IO) {
            val transactions = TransactionDB.getDatabase(this@SearchTransactionActivity)
                .transactionDAO().getApprovedTransactions(receiptId)
    ...
    private fun showEmptyTransactionsMessage() {
        Toast.makeText(this@SearchTransactionActivity, "No hay transacciones para mostrar", Toast.LENGTH_SHORT).show()
    }
